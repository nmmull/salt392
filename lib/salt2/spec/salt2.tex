...
\begin{mathpar}
  \inferrule*[right=var]{
    (x \mapsto \langle t \rangle ^m) \in \G
  }{
  ...
  \inferrule*[right=mutDeref]{
    \G \ent w : \langle \mbrw x \rangle^{m_1}
    \and
    \G \ent x : \langle t \rangle^{m_2}
  }{
    \G \ent \dref w : \langle t \rangle^{m_2}
  ...
  \inferrule*[right=readable]{
    \nexists y,l . (y \mapsto \langle \mbrw \code *^l x \rangle^m) \in \G
  }{
    \readable \G {\code *^k x}
  }
  \and
  ...
  \inferrule*[right=writable]{
    \readable \G {\code *^k x}
    \and
    \nexists y,l . (y \mapsto \langle \brw \code *^l x \rangle^m) \in \G
  }{
    \writable \G {\code *^k x}
  }
  \and
  \inferrule*[right=placeMove]{
    ...
    \G \ent x : \mbrw w \tne \Gamma[x \mapsto \langle \mvty {\mbrw w} \rangle^m]
  }
  \and
  \inferrule*[right=ref]{
    \G \ent w : \langle t \rangle^m
  ...
  \inferrule*[right=mutVar]{
    (x \mapsto \langle t \rangle^\mutt) \in \G
  }{
    \mutable \G x
  }
  \and
  \inferrule*[right=mutDeref]{
    (x \mapsto \langle \mbrw w \rangle^m) \in \G
    \and
    \mutable \G {\code *^k w}
  }{
...
\begin{align*}
  \writee(\G, x, t) &=
  \G[x \mapsto \langle t \rangle^m] \quad \text{where} \quad (x \mapsto \langle \cdot \rangle^m) \in \G\\
  ...
  \mathsf{replace}(\G, w, t_2) &= \{ x \mapsto \langle \mathsf{replace}(\tilde t_1, w, t_2) \rangle^m : (x \mapsto \langle \tilde t_1 \rangle^m) \in \G \} \\
  \\
...
\begin{mathpar}
  ...
  \inferrule*[right=let]{
    ...
    \G_1 \ent \lete x \eqe e \tne \G_2[x \mapsto \langle t \rangle^{\imm}]
  }
  \and
  \inferrule*[right=letMut]{
    ...
    \G_1 \ent \lete \mute x \eqe e \tne \G_2[x \mapsto \langle t \rangle^{\mutt}]
  }
  \and
